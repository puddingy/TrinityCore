...
public:
    ...
    void RollPossibleEnchant(Player* player, Item* item)
    {
        ...
        float Chance1 = sConfigMgr->GetFloatDefault("RandomEnchants.Chance1", 70.0f);
        float Chance2 = sConfigMgr->GetFloatDefault("RandomEnchants.Chance2", 65.0f);
        float Chance3 = sConfigMgr->GetFloatDefault("RandomEnchants.Chance3", 60.0f);
